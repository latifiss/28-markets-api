...
exports.bulkCreatePriceHistory = exports.bulkCreateStatistics = exports.bulkCreateProfiles = exports.getMarketMoversByExchange = exports.getPerformanceByIndustry = exports.getTopLosersByExchange = exports.getTopGainersByExchange = exports.manualGSEStatusUpdate = exports.getGSEMarketStatus = exports.updateLatestPrice = exports.addPriceEntry = exports.deletePriceHistory = exports.getCompanyAllTimePriceHistory = exports.getCompanyPriceHistoryByLast10Years = exports.getCompanyPriceHistoryByLast5Years = exports.getCompanyPriceHistoryByLast2Years = exports.getCompanyPriceHistoryByLast1Year = exports.getCompanyPriceHistoryByYearToDate = exports.getCompanyPriceHistoryByLast6Months = exports.getCompanyPriceHistoryByLast3Months = exports.getCompanyPriceHistoryByLast1Week = exports.getCompanyPriceHistoryByLast24Hours = exports.getCompanyPriceHistory = exports.updatePriceHistory = exports.createPriceHistory = exports.getCompanyAllData = exports.deleteHolders = exports.updateHolders = exports.getHoldersByCompanyId = exports.createHolders = exports.deleteFinancial = exports.updateFinancial = exports.getFinancialByCompanyId = exports.createFinancial = exports.deleteEarnings = exports.updateEarnings = exports.getEarningsByCompanyId = exports.createEarnings = exports.deleteDividends = exports.updateDividends = exports.getDividendsByCompanyId = exports.createDividends = exports.deleteStatistics = exports.updateStatistics = exports.getStatisticsByCompanyId = exports.createStatistics = exports.deleteProfile = exports.updateProfile = exports.getProfileByCompanyId = exports.createProfile = void 0;
exports.bulkImportCompanies = exports.bulkDeleteCompanies = exports.bulkUpsertCollection = exports.bulkUpdateProfiles = exports.bulkUpdateStatistics = exports.bulkAddPriceEntries = void 0;
const stocks_model_1 = require("../models/stocks.model");
...
const invalidateCompanyCache = async (company_id, ticker_symbol) => {
    try {
        const patterns = [
...
const createProfile = async (req, res) => {
    ...
    try {
        ...
        const existingProfile = await stocks_model_1.Profile.findOne({ company_id });
        if (existingProfile) {
            res.status(400).json({
                success: false,
                code: 400,
        ...
        const profile = await stocks_model_1.Profile.create(req.body);
        await invalidateCompanyCache(company_id, (_a = req.body.about) === null || _a === void 0 ? void 0 : _a.ticker_symbol);
        res.status(201).json({
            success: true,
            code: 201,
...
const getProfileByCompanyId = async (req, res) => {
    try {
        ...
        const profile = await stocks_model_1.Profile.findOne({ company_id });
        if (!profile) {
            res.status(404).json({
                success: false,
                code: 404,
...
exports.getProfileByCompanyId = getProfileByCompanyId;
const updateProfile = async (req, res) => {
    var _a;
    try {
        const { company_id } = req.params;
        const currentProfile = await stocks_model_1.Profile.findOne({ company_id });
        if (!currentProfile) {
            res.status(404).json({
                success: false,
                code: 404,
        ...
        const profile = await stocks_model_1.Profile.findOneAndUpdate({ company_id }, req.body, { new: true, runValidators: true });
        if (!profile) {
            res.status(404).json({
                success: false,
                code: 404,
        ...
        await invalidateCompanyCache(company_id, (_a = profile.about) === null || _a === void 0 ? void 0 : _a.ticker_symbol);
        res.status(200).json({
            success: true,
            code: 200,
...
const deleteProfile = async (req, res) => {
    ...
    try {
        const { company_id } = req.params;
        const profile = await stocks_model_1.Profile.findOneAndDelete({ company_id });
        if (!profile) {
            res.status(404).json({
                success: false,
                code: 404,
        ...
        res.status(200).json({
            ...
            data: {
                ...
                company_name: (_b = profile.about) === null || _b === void 0 ? void 0 : _b.company_name,
            },
        });
    }
    catch (error) {
...
const createStatistics = async (req, res) => {
    try {
        ...
        const existingStats = await stocks_model_1.Statistics.findOne({ company_id });
        if (existingStats) {
            res.status(400).json({
                success: false,
                code: 400,
        ...
        const statistics = await stocks_model_1.Statistics.create(req.body);
        if (statistics.addToKeyStatsHistory &&
            typeof statistics.addToKeyStatsHistory === 'function') {
            statistics.addToKeyStatsHistory();
...
const getStatisticsByCompanyId = async (req, res) => {
    try {
        ...
        const statistics = await stocks_model_1.Statistics.findOne({ company_id });
        if (!statistics) {
            res.status(404).json({
                success: false,
                code: 404,
...
exports.getStatisticsByCompanyId = getStatisticsByCompanyId;
const updateStatistics = async (req, res) => {
    ...
    try {
        ...
        if (updateData.key_statistics && !updateData.key_statistics.current_price) {
            updateData.key_statistics.current_price = (_a = existingStats.key_statistics) === null || _a === void 0 ? void 0 : _a.current_price;
        }
        const statistics = await stocks_model_1.Statistics.findOneAndUpdate({ company_id }, updateData, { new: true, runValidators: true });
...
const deleteStatistics = async (req, res) => {
    try {
        const { company_id } = req.params;
        const statistics = await stocks_model_1.Statistics.findOneAndDelete({ company_id });
        if (!statistics) {
            res.status(404).json({
                success: false,
                code: 404,
...
exports.deleteStatistics = deleteStatistics;
const createDividends = async (req, res) => {
    try {
        ...
        const existingDividends = await stocks_model_1.Dividends.findOne({ company_id });
        ...
        const dividends = await stocks_model_1.Dividends.create(req.body);
        if (dividends.addDividendToHistory &&
            typeof dividends.addDividendToHistory === 'function') {
            dividends.addDividendToHistory();
...
exports.createDividends = createDividends;
const getDividendsByCompanyId = async (req, res) => {
    try {
        ...
        const dividends = await stocks_model_1.Dividends.findOne({ company_id });
        if (!dividends) {
            res.status(404).json({
                success: false,
                code: 404,
...
exports.getDividendsByCompanyId = getDividendsByCompanyId;
const updateDividends = async (req, res) => {
    try {
        const { company_id } = req.params;
        const dividends = await stocks_model_1.Dividends.findOneAndUpdate({ company_id }, req.body, { new: true, runValidators: true });
        if (!dividends) {
            res.status(404).json({
                success: false,
                code: 404,
...
exports.updateDividends = updateDividends;
const deleteDividends = async (req, res) => {
    try {
        const { company_id } = req.params;
        const dividends = await stocks_model_1.Dividends.findOneAndDelete({ company_id });
        if (!dividends) {
            res.status(404).json({
                success: false,
                code: 404,
...
exports.deleteDividends = deleteDividends;
const createEarnings = async (req, res) => {
    try {
        ...
        const existingEarnings = await stocks_model_1.Earnings.findOne({ company_id });
        if (existingEarnings) {
            res.status(400).json({
                success: false,
                code: 400,
        ...
        const earnings = await stocks_model_1.Earnings.create(req.body);
        if (earnings.addEarningsToHistory &&
            typeof earnings.addEarningsToHistory === 'function') {
            earnings.addEarningsToHistory('quarterly');
            await earnings.save();
        }
        await invalidateCompanyCache(company_id, req.body.ticker_symbol);
        res.status(201).json({
...
const getEarningsByCompanyId = async (req, res) => {
    try {
        ...
        const earnings = await stocks_model_1.Earnings.findOne({ company_id });
        if (!earnings) {
            res.status(404).json({
                success: false,
                code: 404,
...
exports.getEarningsByCompanyId = getEarningsByCompanyId;
const updateEarnings = async (req, res) => {
    try {
        const { company_id } = req.params;
        const earnings = await stocks_model_1.Earnings.findOneAndUpdate({ company_id }, req.body, { new: true, runValidators: true });
        if (!earnings) {
            res.status(404).json({
                success: false,
                code: 404,
...
const deleteEarnings = async (req, res) => {
    try {
        const { company_id } = req.params;
        const earnings = await stocks_model_1.Earnings.findOneAndDelete({ company_id });
        if (!earnings) {
            res.status(404).json({
                success: false,
                code: 404,
...
exports.deleteEarnings = deleteEarnings;
const createFinancial = async (req, res) => {
    try {
        ...
        const existingFinancial = await stocks_model_1.Financial.findOne({ company_id });
        ...
        const financial = await stocks_model_1.Financial.create(req.body);
        if (financial.addRevenueToHistory &&
            typeof financial.addRevenueToHistory === 'function') {
            financial.addRevenueToHistory('quarterly');
            financial.addNetMarginToHistory('quarterly');
            financial.addDebtToHistory('quarterly');
...
exports.createFinancial = createFinancial;
const getFinancialByCompanyId = async (req, res) => {
    try {
        ...
        const financial = await stocks_model_1.Financial.findOne({ company_id });
        if (!financial) {
            res.status(404).json({
                success: false,
                code: 404,
...
exports.getFinancialByCompanyId = getFinancialByCompanyId;
const updateFinancial = async (req, res) => {
    try {
        const { company_id } = req.params;
        const financial = await stocks_model_1.Financial.findOneAndUpdate({ company_id }, req.body, { new: true, runValidators: true });
        if (!financial) {
            res.status(404).json({
                success: false,
                code: 404,
...
const deleteFinancial = async (req, res) => {
    try {
        const { company_id } = req.params;
        const financial = await stocks_model_1.Financial.findOneAndDelete({ company_id });
        if (!financial) {
            res.status(404).json({
                success: false,
                code: 404,
...
exports.deleteFinancial = deleteFinancial;
const createHolders = async (req, res) => {
    try {
        ...
        const existingHolders = await stocks_model_1.Holders.findOne({ company_id });
        if (existingHolders) {
            res.status(400).json({
                success: false,
                code: 400,
        ...
        const holders = await stocks_model_1.Holders.create(req.body);
        if (holders.addOwnershipToHistory &&
            typeof holders.addOwnershipToHistory === 'function') {
            holders.addOwnershipToHistory();
            await holders.save();
        }
        await invalidateCompanyCache(company_id, req.body.ticker_symbol);
        res.status(201).json({
...
exports.createHolders = createHolders;
const getHoldersByCompanyId = async (req, res) => {
    try {
        ...
        const holders = await stocks_model_1.Holders.findOne({ company_id });
        if (!holders) {
            res.status(404).json({
                success: false,
                code: 404,
...
exports.getHoldersByCompanyId = getHoldersByCompanyId;
const updateHolders = async (req, res) => {
    try {
        const { company_id } = req.params;
        const holders = await stocks_model_1.Holders.findOneAndUpdate({ company_id }, req.body, { new: true, runValidators: true });
        if (!holders) {
            res.status(404).json({
                success: false,
                code: 404,
...
exports.updateHolders = updateHolders;
const deleteHolders = async (req, res) => {
    try {
        const { company_id } = req.params;
        const holders = await stocks_model_1.Holders.findOneAndDelete({ company_id });
        if (!holders) {
            res.status(404).json({
                success: false,
                code: 404,
...
exports.deleteHolders = deleteHolders;
const getCompanyAllData = async (req, res) => {
    try {
        ...
        const [profile, statistics, dividends, earnings, financial, holders] = await Promise.all([
            stocks_model_1.Profile.findOne({ company_id }),
            stocks_model_1.Statistics.findOne({ company_id }),
            stocks_model_1.Dividends.findOne({ company_id }),
            stocks_model_1.Earnings.findOne({ company_id }),
            stocks_model_1.Financial.findOne({ company_id }),
            stocks_model_1.Holders.findOne({ company_id }),
        ]);
        const companyData = {
...
exports.getCompanyAllData = getCompanyAllData;
const createPriceHistory = async (req, res) => {
    try {
        ...
        const existingPriceHistory = await stocks_model_1.PriceHistory.findOne({ company_id });
        ...
        const priceHistory = await stocks_model_1.PriceHistory.create(req.body);
        await invalidateCompanyCache(company_id, req.body.ticker_symbol);
        res.status(201).json({
            success: true,
            code: 201,
...
const updatePriceHistory = async (req, res) => {
    try {
        const { company_id } = req.params;
        const priceHistory = await stocks_model_1.PriceHistory.findOneAndUpdate({ company_id }, req.body, { new: true, runValidators: true });
        if (!priceHistory) {
            res.status(404).json({
                success: false,
                code: 404,
        ...
        (0, ws_1.publishStockUpdate)({ company_id: company_id, ticker_symbol: priceHistory.ticker_symbol }, priceHistory);
        res.status(200).json({
            success: true,
            code: 200,
...
const getCompanyPriceHistory = async (req, res) => {
    try {
        ...
        const priceHistory = await stocks_model_1.PriceHistory.findOne({ company_id });
        if (!priceHistory) {
            res.status(404).json({
                success: false,
                code: 404,
...
const getCompanyPriceHistoryByLast24Hours = async (req, res) => {
    try {
        const { company_id } = req.params;
...
exports.getCompanyPriceHistoryByLast24Hours = getCompanyPriceHistoryByLast24Hours;
const getCompanyPriceHistoryByLast1Week = async (req, res) => {
    try {
        const { company_id } = req.params;
        const endDate = new Date();
...
exports.getCompanyPriceHistoryByLast1Week = getCompanyPriceHistoryByLast1Week;
const getCompanyPriceHistoryByLast3Months = async (req, res) => {
    try {
        const { company_id } = req.params;
        const endDate = new Date();
...
exports.getCompanyPriceHistoryByLast3Months = getCompanyPriceHistoryByLast3Months;
const getCompanyPriceHistoryByLast6Months = async (req, res) => {
    try {
        const { company_id } = req.params;
        const endDate = new Date();
...
exports.getCompanyPriceHistoryByLast6Months = getCompanyPriceHistoryByLast6Months;
const getCompanyPriceHistoryByYearToDate = async (req, res) => {
    try {
        const { company_id } = req.params;
        const endDate = new Date();
...
exports.getCompanyPriceHistoryByYearToDate = getCompanyPriceHistoryByYearToDate;
const getCompanyPriceHistoryByLast1Year = async (req, res) => {
    try {
        const { company_id } = req.params;
        const endDate = new Date();
...
exports.getCompanyPriceHistoryByLast1Year = getCompanyPriceHistoryByLast1Year;
const getCompanyPriceHistoryByLast2Years = async (req, res) => {
    try {
        const { company_id } = req.params;
        const endDate = new Date();
...
exports.getCompanyPriceHistoryByLast2Years = getCompanyPriceHistoryByLast2Years;
const getCompanyPriceHistoryByLast5Years = async (req, res) => {
    try {
        const { company_id } = req.params;
        const endDate = new Date();
...
exports.getCompanyPriceHistoryByLast5Years = getCompanyPriceHistoryByLast5Years;
const getCompanyPriceHistoryByLast10Years = async (req, res) => {
    try {
        const { company_id } = req.params;
        const endDate = new Date();
...
exports.getCompanyPriceHistoryByLast10Years = getCompanyPriceHistoryByLast10Years;
const getCompanyAllTimePriceHistory = async (req, res) => {
    try {
        const { company_id } = req.params;
...
exports.getCompanyAllTimePriceHistory = getCompanyAllTimePriceHistory;
const deletePriceHistory = async (req, res) => {
    try {
        const { company_id } = req.params;
        const priceHistory = await stocks_model_1.PriceHistory.findOneAndDelete({ company_id });
        if (!priceHistory) {
            res.status(404).json({
                success: false,
                code: 404,
...
exports.deletePriceHistory = deletePriceHistory;
const addPriceEntry = async (req, res) => {
    try {
        ...
        priceHistory.history.sort((a, b) => b.date - a.date);
        ...
        await invalidateCompanyCache(company_id, priceHistory.ticker_symbol);
        (0, ws_1.publishStockUpdate)({ company_id: company_id, ticker_symbol: priceHistory.ticker_symbol }, { event: 'price_entry_added', newEntry: { date: new Date(date), price: String(price) } });
        res.status(200).json({
            success: true,
            code: 200,
...
const updateLatestPrice = async (req, res) => {
    try {
        ...
        priceHistory.history.push(newEntry);
        const MAX_HISTORY_ENTRIES = 5000;
        if (priceHistory.history.length > MAX_HISTORY_ENTRIES) {
            priceHistory.history = priceHistory.history.slice(-MAX_HISTORY_ENTRIES);
        }
        await priceHistory.save();
        await invalidateCompanyCache(company_id, priceHistory.ticker_symbol);
        (0, ws_1.publishStockUpdate)({ company_id: company_id, ticker_symbol: priceHistory.ticker_symbol }, { event: 'latest_price_updated', latestPrice: newEntry });
        res.status(200).json({
            success: true,
            code: 200,
...
const getGSEMarketStatus = async (req, res) => {
    try {
        ...
        const isPublicHoliday = (date = new Date()) => {
            ...
            return PUBLIC_HOLIDAYS.some((holiday) => holiday.month === month && holiday.day === day);
        };
        const isTradingDay = () => {
            const now = new Date();
            const ghanaDate = new Date(now.toLocaleString('en-US', { timeZone: TIMEZONE }));
...
exports.getGSEMarketStatus = getGSEMarketStatus;
const manualGSEStatusUpdate = async (req, res) => {
    try {
        const TRADING_START = { hour: 10, minute: 0 };
        const TRADING_END = { hour: 15, minute: 0 };
        const TIMEZONE = 'Africa/Accra';
...
exports.manualGSEStatusUpdate = manualGSEStatusUpdate;
const getTopGainersByExchange = async (req, res) => {
    try {
        ...
        const profiles = await stocks_model_1.Profile.find({
        ...
        const statistics = await stocks_model_1.Statistics.find({
        ...
        const gainers = profiles
            ...
            .sort((a, b) => ((b === null || b === void 0 ? void 0 : b.percentage_change) || 0) - ((a === null || a === void 0 ? void 0 : a.percentage_change) || 0))
...
exports.getTopGainersByExchange = getTopGainersByExchange;
const getTopLosersByExchange = async (req, res) => {
    try {
        const { exchangeSymbol } = req.params;
        const { limit = 20 } = req.query;
        ...
        const losers = profiles
            ...
            .filter(item => item !== null && item.percentage_change < 0)
            .sort((a, b) => ((a === null || a === void 0 ? void 0 : a.percentage_change) || 0) - ((b === null || b === void 0 ? void 0 : b.percentage_change) || 0))
            .slice(0, Number(limit));
...
exports.getTopLosersByExchange = getTopLosersByExchange;
const getPerformanceByIndustry = async (req, res) => {
    try {
        const { exchangeSymbol } = req.params;
        ...
        profiles.forEach(profile => {
            ...
            if (stats.percentage_change > 0)
                industryData.gainers_count++;
            else if (stats.percentage_change < 0)
                industryData.losers_count++;
            else
                industryData.unchanged_count++;
        ...
        const industries = Array.from(industryMap.values()).map(industry => {
            ...
            industry.companies.sort((a, b) => (b.percentage_change || 0) - (a.percentage_change || 0));
...
exports.getPerformanceByIndustry = getPerformanceByIndustry;
...
const getMarketMoversByExchange = async (req, res) => {
    try {
        const { exchangeSymbol } = req.params;
...
exports.getMarketMoversByExchange = getMarketMoversByExchange;
const bulkCreateProfiles = async (req, res) => {
    var _a;
    try {
        ...
        for (const company of companies) {
            try {
                ...
                const profile = await stocks_model_1.Profile.create(company);
                await invalidateCompanyCache(company_id, (_a = company.about) === null || _a === void 0 ? void 0 : _a.ticker_symbol);
...
exports.bulkCreateProfiles = bulkCreateProfiles;
const bulkCreateStatistics = async (req, res) => {
    try {
        ...
        for (const stat of statistics) {
            try {
                ...
                const statisticsDoc = await stocks_model_1.Statistics.create(stat);
                if (statisticsDoc.addToKeyStatsHistory) {
                    statisticsDoc.addToKeyStatsHistory();
...
exports.bulkCreateStatistics = bulkCreateStatistics;
const bulkCreatePriceHistory = async (req, res) => {
    try {
        ...
        for (const history of priceHistories) {
            try {
                ...
                const existingHistory = await stocks_model_1.PriceHistory.findOne({ company_id });
                if (existingHistory) {
                    result.failed.push({
                        company_id,
                        operation: 'create_price_history',
                ...
                const priceHistory = await stocks_model_1.PriceHistory.create(history);
...
exports.bulkCreatePriceHistory = bulkCreatePriceHistory;
const bulkAddPriceEntries = async (req, res) => {
    try {
...
exports.bulkAddPriceEntries = bulkAddPriceEntries;
const bulkUpdateStatistics = async (req, res) => {
    try {
        ...
        for (const update of updates) {
            try {
                ...
                const statistics = await stocks_model_1.Statistics.findOneAndUpdate({ company_id }, data, { new: true, runValidators: true });
                if (!statistics) {
                    result.failed.push({
                        company_id,
                        operation: 'update_statistics',
...
exports.bulkUpdateStatistics = bulkUpdateStatistics;
const bulkUpdateProfiles = async (req, res) => {
    var _a;
    try {
        const { updates } = req.body;
        if (!updates || !Array.isArray(updates) || updates.length === 0) {
        ...
        for (const update of updates) {
            try {
                ...
                const profile = await stocks_model_1.Profile.findOneAndUpdate({ company_id }, data, { new: true, runValidators: true });
                if (!profile) {
                    result.failed.push({
                        company_id,
                        operation: 'update_profile',
...
exports.bulkUpdateProfiles = bulkUpdateProfiles;
const bulkUpsertCollection = async (req, res) => {
    try {
        ...
        switch (collection) {
            case 'profiles':
                Model = stocks_model_1.Profile;
                break;
            case 'statistics':
                Model = stocks_model_1.Statistics;
                break;
            case 'dividends':
                Model = stocks_model_1.Dividends;
                break;
            case 'earnings':
                Model = stocks_model_1.Earnings;
                break;
            case 'financial':
                Model = stocks_model_1.Financial;
                break;
            case 'holders':
                Model = stocks_model_1.Holders;
                break;
            case 'priceHistory':
                Model = stocks_model_1.PriceHistory;
                break;
        }
        const result = {
            successful: [],
        ...
        for (const item of items) {
            try {
                ...
                if (existing) {
                    await Model.findOneAndUpdate({ company_id }, item, { new: true, runValidators: true });
                }
                else {
...
exports.bulkUpsertCollection = bulkUpsertCollection;
const bulkDeleteCompanies = async (req, res) => {
    try {
        ...
        const validCollections = ['profiles', 'statistics', 'dividends', 'earnings', 'financial', 'holders', 'priceHistory'];
        const invalidCollections = collectionsToDelete.filter((c) => !validCollections.includes(c));
        ...
        for (const company_id of company_ids) {
            try {
                ...
                if (collectionsToDelete.includes('statistics')) {
                    const stats = await stocks_model_1.Statistics.findOneAndDelete({ company_id });
                    if (stats)
                        deletedFrom.push('statistics');
                }
                if (collectionsToDelete.includes('dividends')) {
                    const dividends = await stocks_model_1.Dividends.findOneAndDelete({ company_id });
                    if (dividends)
                        deletedFrom.push('dividends');
                }
                if (collectionsToDelete.includes('earnings')) {
                    const earnings = await stocks_model_1.Earnings.findOneAndDelete({ company_id });
                    if (earnings)
                        deletedFrom.push('earnings');
                }
                if (collectionsToDelete.includes('financial')) {
                    const financial = await stocks_model_1.Financial.findOneAndDelete({ company_id });
                    if (financial)
                        deletedFrom.push('financial');
                }
                if (collectionsToDelete.includes('holders')) {
                    const holders = await stocks_model_1.Holders.findOneAndDelete({ company_id });
                    if (holders)
                        deletedFrom.push('holders');
                }
...
exports.bulkDeleteCompanies = bulkDeleteCompanies;
        ...
        for (const company of companies) {
            ...
            try {
                if (profile) {
                    const existingProfile = await stocks_model_1.Profile.findOne({ company_id });
                    if (!existingProfile) {
                        await stocks_model_1.Profile.create({ company_id, ...profile });
                ...
                if (statistics) {
                    const existingStats = await stocks_model_1.Statistics.findOne({ company_id });
                    if (!existingStats) {
                        const statsDoc = await stocks_model_1.Statistics.create({ company_id, ...statistics });
                        if (statsDoc.addToKeyStatsHistory) {
                            statsDoc.addToKeyStatsHistory();
                            await statsDoc.save();
                        }
                ...
                if (dividends) {
                    const existingDividends = await stocks_model_1.Dividends.findOne({ company_id });
                    if (!existingDividends) {
                        const divDoc = await stocks_model_1.Dividends.create({ company_id, ...dividends });
                        if (divDoc.addDividendToHistory) {
                            divDoc.addDividendToHistory();
                            await divDoc.save();
                        }
                ...
                if (earnings) {
                    const existingEarnings = await stocks_model_1.Earnings.findOne({ company_id });
                    if (!existingEarnings) {
                        const earnDoc = await stocks_model_1.Earnings.create({ company_id, ...earnings });
                        if (earnDoc.addEarningsToHistory) {
                            earnDoc.addEarningsToHistory('quarterly');
                            await earnDoc.save();
                        }
                ...
                if (financial) {
                    const existingFinancial = await stocks_model_1.Financial.findOne({ company_id });
                    if (!existingFinancial) {
                        const finDoc = await stocks_model_1.Financial.create({ company_id, ...financial });
                        if (finDoc.addRevenueToHistory) {
                            finDoc.addRevenueToHistory('quarterly');
                            finDoc.addNetMarginToHistory('quarterly');
                            finDoc.addDebtToHistory('quarterly');
                            await finDoc.save();
                        }
                ...
                if (holders) {
                    const existingHolders = await stocks_model_1.Holders.findOne({ company_id });
                    if (!existingHolders) {
                        const holdDoc = await stocks_model_1.Holders.create({ company_id, ...holders });
                        if (holdDoc.addOwnershipToHistory) {
                            holdDoc.addOwnershipToHistory();
                            await holdDoc.save();
                        }
                ...
                if (priceHistory) {
                    const existingPriceHistory = await stocks_model_1.PriceHistory.findOne({ company_id });
                    if (!existingPriceHistory) {
                        await stocks_model_1.PriceHistory.create({ company_id, ...priceHistory });
