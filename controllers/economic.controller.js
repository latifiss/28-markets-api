...
exports.getGovernmentDebtToGDPHistory =
  exports.deleteGovernmentDebtToGDP =
  exports.updateGovernmentDebtToGDP =
  exports.getLatestGovernmentDebtToGDP =
  exports.getAllGovernmentDebtToGDP =
  exports.createGovernmentDebtToGDP =
  exports.getBalanceOfTradeHistory =
  exports.deleteBalanceOfTrade =
  exports.updateBalanceOfTrade =
  exports.getLatestBalanceOfTrade =
  exports.getAllBalanceOfTrade =
  exports.createBalanceOfTrade =
  exports.getUnemploymentRateHistory =
  exports.deleteUnemploymentRate =
  exports.updateUnemploymentRate =
  exports.getLatestUnemploymentRate =
  exports.getAllUnemploymentRate =
  exports.createUnemploymentRate =
  exports.getInflationRateHistory =
  exports.deleteInflationRate =
  exports.updateInflationRate =
  exports.getLatestInflationRate =
  exports.getAllInflationRate =
  exports.createInflationRate =
  exports.getInterestRateHistory =
  exports.deleteInterestRate =
  exports.updateInterestRate =
  exports.getLatestInterestRate =
  exports.getAllInterestRate =
  exports.createInterestRate =
  exports.getGovernmentGDPValueHistory =
  exports.deleteGovernmentGDPValue =
  exports.updateGovernmentGDPValue =
  exports.getLatestGovernmentGDPValue =
  exports.getAllGovernmentGDPValue =
  exports.createGovernmentGDPValue =
  exports.getGDPGrowthAnnualHistory =
  exports.deleteGDPGrowthAnnual =
  exports.updateGDPGrowthAnnual =
  exports.getLatestGDPGrowthAnnual =
  exports.getAllGDPGrowthAnnual =
  exports.createGDPGrowthAnnual =
  exports.getGDPGrowthQuarterlyHistory =
  exports.deleteGDPGrowthQuarterly =
  exports.updateGDPGrowthQuarterly =
  exports.getLatestGDPGrowthQuarterly =
  exports.getAllGDPGrowthQuarterly =
  exports.createGDPGrowthQuarterly =
  exports.getCache =
  exports.setCache =
    void 0;
exports.bulkUpdateIndicators =
  exports.getGovernmentSpendingHistory =
  exports.deleteGovernmentSpending =
  exports.updateGovernmentSpending =
  exports.getLatestGovernmentSpending =
  exports.getAllGovernmentSpending =
  exports.createGovernmentSpending =
  exports.getFiscalExpenditureHistory =
  exports.deleteFiscalExpenditure =
  exports.updateFiscalExpenditure =
  exports.getLatestFiscalExpenditure =
  exports.getAllFiscalExpenditure =
  exports.createFiscalExpenditure =
  exports.getGovernmentRevenuesHistory =
  exports.deleteGovernmentRevenues =
  exports.updateGovernmentRevenues =
  exports.getLatestGovernmentRevenues =
  exports.getAllGovernmentRevenues =
  exports.createGovernmentRevenues =
  exports.getGovernmentBudgetValueHistory =
  exports.deleteGovernmentBudgetValue =
  exports.updateGovernmentBudgetValue =
  exports.getLatestGovernmentBudgetValue =
  exports.getAllGovernmentBudgetValue =
  exports.createGovernmentBudgetValue =
  exports.getGovernmentDebtValueHistory =
  exports.deleteGovernmentDebtValue =
  exports.updateGovernmentDebtValue =
  exports.getLatestGovernmentDebtValue =
  exports.getAllGovernmentDebtValue =
  exports.createGovernmentDebtValue =
    void 0;
...
const getLatestHandler = async (Model, req, res, indicatorName) => {
  try {
    ...
    const latest = await (Model.findLatest
      ? Model.findLatest()
      : Model.findOne().sort({ year: -1 }));
    if (!latest) {
      res.status(404).json({
        success: false,
        code: 404,
...
const getHistoryHandler = async (Model, req, res, indicatorName) => {
  try {
    ...
    const history = await Model.find(query)
      .select(
        'year month quarter current_value previous_value current_balance previous_balance',
      )
...
const createGDPGrowthQuarterly = async (req, res) =>
  createHandler(
    economic_model_1.GDPGrowthQuarterly,
    req,
    res,
    'GDP Growth Quarterly',
  );
exports.createGDPGrowthQuarterly = createGDPGrowthQuarterly;
const getAllGDPGrowthQuarterly = async (req, res) =>
  getAllHandler(
    economic_model_1.GDPGrowthQuarterly,
    req,
    res,
...
const getLatestGDPGrowthQuarterly = async (req, res) =>
  getLatestHandler(
    economic_model_1.GDPGrowthQuarterly,
    req,
    res,
...
const updateGDPGrowthQuarterly = async (req, res) =>
  updateHandler(
    economic_model_1.GDPGrowthQuarterly,
    req,
    res,
...
const deleteGDPGrowthQuarterly = async (req, res) =>
  deleteHandler(
    economic_model_1.GDPGrowthQuarterly,
    req,
    res,
...
const getGDPGrowthQuarterlyHistory = async (req, res) =>
  getHistoryHandler(
    economic_model_1.GDPGrowthQuarterly,
    req,
    res,
...
const createGDPGrowthAnnual = async (req, res) =>
  createHandler(
    economic_model_1.GDPGrowthAnnual,
    req,
    res,
    'GDP Growth Annual',
  );
exports.createGDPGrowthAnnual = createGDPGrowthAnnual;
const getAllGDPGrowthAnnual = async (req, res) =>
  getAllHandler(
    economic_model_1.GDPGrowthAnnual,
    req,
    res,
...
const getLatestGDPGrowthAnnual = async (req, res) =>
  getLatestHandler(
    economic_model_1.GDPGrowthAnnual,
    req,
    res,
...
const updateGDPGrowthAnnual = async (req, res) =>
  updateHandler(
    economic_model_1.GDPGrowthAnnual,
    req,
    res,
...
const deleteGDPGrowthAnnual = async (req, res) =>
  deleteHandler(
    economic_model_1.GDPGrowthAnnual,
    req,
    res,
...
const getGDPGrowthAnnualHistory = async (req, res) =>
  getHistoryHandler(
    economic_model_1.GDPGrowthAnnual,
    req,
    res,
...
const createGovernmentGDPValue = async (req, res) =>
  createHandler(
    economic_model_1.GovernmentGDPValue,
    req,
    res,
    'Government GDP Value',
  );
exports.createGovernmentGDPValue = createGovernmentGDPValue;
const getAllGovernmentGDPValue = async (req, res) =>
  getAllHandler(
    economic_model_1.GovernmentGDPValue,
    req,
    res,
...
const getLatestGovernmentGDPValue = async (req, res) =>
  getLatestHandler(
    economic_model_1.GovernmentGDPValue,
    req,
    res,
...
const updateGovernmentGDPValue = async (req, res) =>
  updateHandler(
    economic_model_1.GovernmentGDPValue,
    req,
    res,
...
const deleteGovernmentGDPValue = async (req, res) =>
  deleteHandler(
    economic_model_1.GovernmentGDPValue,
    req,
    res,
...
const getGovernmentGDPValueHistory = async (req, res) =>
  getHistoryHandler(
    economic_model_1.GovernmentGDPValue,
    req,
    res,
...
const createInterestRate = async (req, res) =>
  createHandler(economic_model_1.InterestRate, req, res, 'Interest Rate');
exports.createInterestRate = createInterestRate;
const getAllInterestRate = async (req, res) =>
  getAllHandler(economic_model_1.InterestRate, req, res, 'Interest Rate');
exports.getAllInterestRate = getAllInterestRate;
const getLatestInterestRate = async (req, res) =>
  getLatestHandler(economic_model_1.InterestRate, req, res, 'Interest Rate');
exports.getLatestInterestRate = getLatestInterestRate;
const updateInterestRate = async (req, res) =>
  updateHandler(economic_model_1.InterestRate, req, res, 'Interest Rate');
exports.updateInterestRate = updateInterestRate;
const deleteInterestRate = async (req, res) =>
  deleteHandler(economic_model_1.InterestRate, req, res, 'Interest Rate');
exports.deleteInterestRate = deleteInterestRate;
const getInterestRateHistory = async (req, res) =>
  getHistoryHandler(economic_model_1.InterestRate, req, res, 'Interest Rate');
exports.getInterestRateHistory = getInterestRateHistory;

const createInflationRate = async (req, res) =>
  createHandler(economic_model_1.InflationRate, req, res, 'Inflation Rate');
exports.createInflationRate = createInflationRate;
const getAllInflationRate = async (req, res) =>
  getAllHandler(economic_model_1.InflationRate, req, res, 'Inflation Rate');
exports.getAllInflationRate = getAllInflationRate;
const getLatestInflationRate = async (req, res) =>
  getLatestHandler(economic_model_1.InflationRate, req, res, 'Inflation Rate');
exports.getLatestInflationRate = getLatestInflationRate;
const updateInflationRate = async (req, res) =>
  updateHandler(economic_model_1.InflationRate, req, res, 'Inflation Rate');
exports.updateInflationRate = updateInflationRate;
const deleteInflationRate = async (req, res) =>
  deleteHandler(economic_model_1.InflationRate, req, res, 'Inflation Rate');
exports.deleteInflationRate = deleteInflationRate;
const getInflationRateHistory = async (req, res) =>
  getHistoryHandler(economic_model_1.InflationRate, req, res, 'Inflation Rate');
exports.getInflationRateHistory = getInflationRateHistory;

const createUnemploymentRate = async (req, res) =>
  createHandler(
    economic_model_1.UnemploymentRate,
    req,
    res,
    'Unemployment Rate',
  );
exports.createUnemploymentRate = createUnemploymentRate;
const getAllUnemploymentRate = async (req, res) =>
  getAllHandler(
    economic_model_1.UnemploymentRate,
    req,
    res,
...
const getLatestUnemploymentRate = async (req, res) =>
  getLatestHandler(
    economic_model_1.UnemploymentRate,
    req,
    res,
...
const updateUnemploymentRate = async (req, res) =>
  updateHandler(
    economic_model_1.UnemploymentRate,
    req,
    res,
...
const deleteUnemploymentRate = async (req, res) =>
  deleteHandler(
    economic_model_1.UnemploymentRate,
    req,
    res,
...
const getUnemploymentRateHistory = async (req, res) =>
  getHistoryHandler(
    economic_model_1.UnemploymentRate,
    req,
    res,
...
const createBalanceOfTrade = async (req, res) =>
  createHandler(economic_model_1.BalanceOfTrade, req, res, 'Balance of Trade');
exports.createBalanceOfTrade = createBalanceOfTrade;
const getAllBalanceOfTrade = async (req, res) =>
  getAllHandler(economic_model_1.BalanceOfTrade, req, res, 'Balance of Trade');
exports.getAllBalanceOfTrade = getAllBalanceOfTrade;
const getLatestBalanceOfTrade = async (req, res) =>
  getLatestHandler(
    economic_model_1.BalanceOfTrade,
    req,
    res,
    'Balance of Trade',
  );
exports.getLatestBalanceOfTrade = getLatestBalanceOfTrade;
const updateBalanceOfTrade = async (req, res) =>
  updateHandler(economic_model_1.BalanceOfTrade, req, res, 'Balance of Trade');
exports.updateBalanceOfTrade = updateBalanceOfTrade;
const deleteBalanceOfTrade = async (req, res) =>
  deleteHandler(economic_model_1.BalanceOfTrade, req, res, 'Balance of Trade');
exports.deleteBalanceOfTrade = deleteBalanceOfTrade;
const getBalanceOfTradeHistory = async (req, res) =>
  getHistoryHandler(
    economic_model_1.BalanceOfTrade,
    req,
    res,
...
const createGovernmentDebtToGDP = async (req, res) =>
  createHandler(
    economic_model_1.GovernmentDebtToGDP,
    req,
    res,
    'Government Debt to GDP',
  );
exports.createGovernmentDebtToGDP = createGovernmentDebtToGDP;
const getAllGovernmentDebtToGDP = async (req, res) =>
  getAllHandler(
    economic_model_1.GovernmentDebtToGDP,
    req,
    res,
...
const getLatestGovernmentDebtToGDP = async (req, res) =>
  getLatestHandler(
    economic_model_1.GovernmentDebtToGDP,
    req,
    res,
...
const updateGovernmentDebtToGDP = async (req, res) =>
  updateHandler(
    economic_model_1.GovernmentDebtToGDP,
    req,
    res,
...
const deleteGovernmentDebtToGDP = async (req, res) =>
  deleteHandler(
    economic_model_1.GovernmentDebtToGDP,
    req,
    res,
...
const getGovernmentDebtToGDPHistory = async (req, res) =>
  getHistoryHandler(
    economic_model_1.GovernmentDebtToGDP,
    req,
    res,
...
const createGovernmentDebtValue = async (req, res) =>
  createHandler(
    economic_model_1.GovernmentDebtValue,
    req,
    res,
    'Government Debt Value',
  );
exports.createGovernmentDebtValue = createGovernmentDebtValue;
const getAllGovernmentDebtValue = async (req, res) =>
  getAllHandler(
    economic_model_1.GovernmentDebtValue,
    req,
    res,
...
const getLatestGovernmentDebtValue = async (req, res) =>
  getLatestHandler(
    economic_model_1.GovernmentDebtValue,
    req,
    res,
...
const updateGovernmentDebtValue = async (req, res) =>
  updateHandler(
    economic_model_1.GovernmentDebtValue,
    req,
    res,
...
const deleteGovernmentDebtValue = async (req, res) =>
  deleteHandler(
    economic_model_1.GovernmentDebtValue,
    req,
    res,
...
const getGovernmentDebtValueHistory = async (req, res) =>
  getHistoryHandler(
    economic_model_1.GovernmentDebtValue,
    req,
    res,
...
const createGovernmentBudgetValue = async (req, res) =>
  createHandler(
    economic_model_1.GovernmentBudgetValue,
    req,
    res,
    'Government Budget Value',
  );
exports.createGovernmentBudgetValue = createGovernmentBudgetValue;
const getAllGovernmentBudgetValue = async (req, res) =>
  getAllHandler(
    economic_model_1.GovernmentBudgetValue,
    req,
    res,
...
const getLatestGovernmentBudgetValue = async (req, res) =>
  getLatestHandler(
    economic_model_1.GovernmentBudgetValue,
    req,
    res,
...
const updateGovernmentBudgetValue = async (req, res) =>
  updateHandler(
    economic_model_1.GovernmentBudgetValue,
    req,
    res,
...
const deleteGovernmentBudgetValue = async (req, res) =>
  deleteHandler(
    economic_model_1.GovernmentBudgetValue,
    req,
    res,
...
const getGovernmentBudgetValueHistory = async (req, res) =>
  getHistoryHandler(
    economic_model_1.GovernmentBudgetValue,
    req,
    res,
...
const createGovernmentRevenues = async (req, res) =>
  createHandler(
    economic_model_1.GovernmentRevenues,
    req,
    res,
    'Government Revenues',
  );
exports.createGovernmentRevenues = createGovernmentRevenues;
const getAllGovernmentRevenues = async (req, res) =>
  getAllHandler(
    economic_model_1.GovernmentRevenues,
    req,
    res,
...
const getLatestGovernmentRevenues = async (req, res) =>
  getLatestHandler(
    economic_model_1.GovernmentRevenues,
    req,
    res,
...
const updateGovernmentRevenues = async (req, res) =>
  updateHandler(
    economic_model_1.GovernmentRevenues,
    req,
    res,
...
const deleteGovernmentRevenues = async (req, res) =>
  deleteHandler(
    economic_model_1.GovernmentRevenues,
    req,
    res,
...
const getGovernmentRevenuesHistory = async (req, res) =>
  getHistoryHandler(
    economic_model_1.GovernmentRevenues,
    req,
    res,
...
const createFiscalExpenditure = async (req, res) =>
  createHandler(
    economic_model_1.FiscalExpenditure,
    req,
    res,
    'Fiscal Expenditure',
  );
exports.createFiscalExpenditure = createFiscalExpenditure;
const getAllFiscalExpenditure = async (req, res) =>
  getAllHandler(
    economic_model_1.FiscalExpenditure,
    req,
    res,
...
const getLatestFiscalExpenditure = async (req, res) =>
  getLatestHandler(
    economic_model_1.FiscalExpenditure,
    req,
    res,
...
const updateFiscalExpenditure = async (req, res) =>
  updateHandler(
    economic_model_1.FiscalExpenditure,
    req,
    res,
...
const deleteFiscalExpenditure = async (req, res) =>
  deleteHandler(
    economic_model_1.FiscalExpenditure,
    req,
    res,
...
const getFiscalExpenditureHistory = async (req, res) =>
  getHistoryHandler(
    economic_model_1.FiscalExpenditure,
    req,
    res,
...
const createGovernmentSpending = async (req, res) =>
  createHandler(
    economic_model_1.GovernmentSpending,
    req,
    res,
    'Government Spending',
  );
exports.createGovernmentSpending = createGovernmentSpending;
const getAllGovernmentSpending = async (req, res) =>
  getAllHandler(
    economic_model_1.GovernmentSpending,
    req,
    res,
...
const getLatestGovernmentSpending = async (req, res) =>
  getLatestHandler(
    economic_model_1.GovernmentSpending,
    req,
    res,
...
const updateGovernmentSpending = async (req, res) =>
  updateHandler(
    economic_model_1.GovernmentSpending,
    req,
    res,
...
const deleteGovernmentSpending = async (req, res) =>
  deleteHandler(
    economic_model_1.GovernmentSpending,
    req,
    res,
...
const getGovernmentSpendingHistory = async (req, res) =>
  getHistoryHandler(
    economic_model_1.GovernmentSpending,
    req,
    res,
    ...
    for (const indicator of indicatorsData) {
      try {
        ...
        if (
          idStr &&
          typeof idStr === 'string' &&
          mongoose_1.default.Types.ObjectId.isValid(idStr)
        ) {
          ...
          errors.push({
            ...
            id,
            error:
              'Missing required query parameters (id or year/month/quarter)',
          });
          continue;
        }
